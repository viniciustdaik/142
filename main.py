...
def popular_movies():
    ...
    # output.iterrows: iterrows(): É uma função do Pandas que é usada para iterar pelas linhas do DataFrame.
    # Ela retorna um iterador que produz pares de (índice, linha), onde o índice é o índice da linha no DataFrame,
    # e a linha é uma série (ou seja, uma linha) de dados.
...
def recommended_movies():
    global liked_movies
    col_names = ["original_title", "poster_link",
                 "release_date", "runtime", "weighted_rating"]
